...
<body>
    ...
    <div class="container">
        <h1>The Catcher in the Rye</h1> <!-- Use htmlspecialchars for safety -->
        <div class="book-details">
            <p><strong>Author:</strong> 246</p>
        ...
        <div class="cover-photo" onclick="toggleBookDetails()">
            <img src="data:image/jpeg;base64,Si5ELiBTYWxpbmdlcg==" alt="Cover Photo">
        </div>
